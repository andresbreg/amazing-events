...
function detailsDataFetch() {
  fetch('https://mindhub-xj03.onrender.com/api/amazing')
    .then(response => response.json())
    .then(apiData => {
      currentDate = apiData.currentDate;
      allEvents = apiData.events;
      eventDetails = allEvents.filter(event => event._id == id);
      showDetailsCard();
    })
      ...
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <h4 class="card-title details-card-title fw-bolder text-center">${eventDetails[0].name}<span class="badge rounded-pill">$${eventDetails[0].price}</span></h5>
